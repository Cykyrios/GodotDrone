...
func _ready() -> void:
	...
	label.append_text("\n\n")
	label.append_text("You need a gamepad or radio transmitter to play, or really any device with 4 axes ")
	label.append_text("that your computer recognizes.")
	label.append_text("\n\n")
	...
	label.append_text("\n\n")
	label.append_text("All stabilized modes hold altitude as well. Stabilized modes trigger recovery mode ")
	label.append_text("when a bank angle of 45 degrees is exceeded.")
	label.append_text("\n\n")
	...
	label.append_text("should be flicked/pressed. In the controls menu, \"Arm (hold)\" is supposed to be used ")
	label.append_text("with a switch, and \"Arm (toggle)\" is supposed to be used with a button.")
	label.append_text("\n\n")
