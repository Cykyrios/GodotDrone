...
func _ready():
	...
	button_low.connect("button_down", self, "_on_button_pressed", [1])
	button_high.connect("button_down", self, "_on_button_pressed", [2])
	button_low.connect("button_up", self, "_on_button_released")
	button_high.connect("button_up", self, "_on_button_released")
...
func set_bounds(low: float, high: float):
