...
func _ready() -> void:
	...
	_discard = rate_pitch_slider.connect("value_changed", self, "_on_rate_changed", [rate_pitch_slider])
	_discard = rate_roll_slider.connect("value_changed", self, "_on_rate_changed", [rate_roll_slider])
	_discard = rate_yaw_slider.connect("value_changed", self, "_on_rate_changed", [rate_yaw_slider])
	_discard = expo_pitch_slider.connect("value_changed", self, "_on_expo_changed", [expo_pitch_slider])
	_discard = expo_roll_slider.connect("value_changed", self, "_on_expo_changed", [expo_roll_slider])
	_discard = expo_yaw_slider.connect("value_changed", self, "_on_expo_changed", [expo_yaw_slider])
